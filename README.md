...
* 서울시 구별 PM10/PM2.5 농도를 색상 등급(좋음·보통·나쁨)으로 직관적으로 표시
...
* 애견카페 별 리뷰 등록·조회 (UI 미구현 상태)
* 미세먼지 임계값 알림 구독 (푸시 알림 기능은 추후 지원 예정)
...
![미세먼지 지도](docs/screenshots/airmap.png)
...
![산책 장소 추천](docs/screenshots/walking_places.png)
...
![건강 가이드](docs/screenshots/health_guide.png)
